...
final class Version20260420132731 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cartline ADD CONSTRAINT FK_AC6FBE4FA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
        $this->addSql('ALTER TABLE cartline ADD CONSTRAINT FK_AC6FBE4F4584665A FOREIGN KEY (product_id) REFERENCES product (id)');
    ...
    {
        $this->addSql('ALTER TABLE cartline DROP FOREIGN KEY FK_AC6FBE4FA76ED395');
        ...
        $this->addSql('ALTER TABLE cartline DROP COLUMN user_id');
        $this->addSql('ALTER TABLE cartline DROP COLUMN product_id');
        ...
        $this->addSql('ALTER TABLE order_line DROP COLUMN product_id');
        $this->addSql('ALTER TABLE order_line DROP COLUMN order_id');
    }
}
